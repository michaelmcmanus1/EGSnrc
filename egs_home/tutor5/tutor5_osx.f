      ...
      real*8 XIN,YIN,ZIN,EIN,WTIN,UIN,VIN,WIN,ANORM
...
1012  CONTINUE
      ...
      IRAYLR(2)=1
      WRITE(6,1020)
1020  FORMAT('1  Start tutor5'//' Call HATCH to get cross-section data'/
     *)
      CALL HATCH
...
1061  CONTINUE
1062  CONTINUE
      WRITE(6,1070)EIN*1000.,ZBOUND, PCUT(2), (ANORM*COUNT(I),ENTOT(I),I
     *=1,3)
1070  FORMAT(//' For',F6.1,' keV photons incident on',F4.1,' cm OF H2O'/
     *' with PCUT=',F5.3,' MeV' //' Transmitted primaries=',T40,F8.2,'% 
     * ave energy=',F10.3,' MeV'// ' Fraction rayleigh scattering=',T40,
     *F8.2,'%  ave energy=',F10.3,' MeV' //' Fraction compton scattering
     * only=',T40,F8.2,'%  ave energy=',F10.3, ' MeV'//)
      call egs_finish
      STOP
      END
