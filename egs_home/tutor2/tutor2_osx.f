      ...
      real*8 XIN,YIN,ZIN,EIN,WTIN,UIN,VIN,WIN,ANORM,TOTAL
...
1012  CONTINUE
      ...
      PCUT(2)=0.1
      WRITE(6,1020)
1020  FORMAT('\f  Start tutor2'//' CALL HATCH to get cross-section data'
     */)
      CALL HATCH
...
1061  CONTINUE
1062  CONTINUE
      WRITE(6,1070)NCASE, (ESCORE(I)*ANORM,I=1,3),TOTAL*ANORM
1070  FORMAT(//' For',I8,' incident particles'/ ' Fraction of energy ref
     *lected from plate=',T50,F10.3,'%'/ ' Fraction of energy depositedi
     *n plate=',T50,F10.3,'%'/ ' Fraction of energy transmitted through 
     *plate=',T50,F10.3,'%'/ T50,11('-')/' Total fraction of energy acco
     *unted for=', T50,F10.3,'%'///)
      call egs_finish
      STOP
      END
